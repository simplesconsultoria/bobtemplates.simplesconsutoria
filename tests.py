    ...
    def test_addon_template(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.project + '/src/customer/site/addon/upgrades/v1010',
                self.project + '/src/customer/site/addon/upgrades/v1010/__init__.py',
                self.project + '/src/customer/site/addon/upgrades/v1010/configure.zcml',
