    ...
    def test_addon_template(self):
        ...
        self.assertItemsEqual(
            ...
            [
                ...
                self.project + '/src/customer/site/addon/controlpanel.py',
                self.project + '/src/customer/site/addon/Extensions',
                self.project + '/src/customer/site/addon/Extensions/__init__.py',
                self.project + '/src/customer/site/addon/Extensions/Install.py',
                ...
                self.project + '/src/customer/site/addon/profiles/default/controlpanel.xml',
                self.project + '/src/customer/site/addon/profiles/default/metadata.xml',
                self.project + '/src/customer/site/addon/profiles/default/registry.xml',
                ...
                self.project + '/src/customer/site/addon/profiles/uninstall/registry.xml',
                self.project + '/src/customer/site/addon/setuphandlers.py',
                self.project + '/src/customer/site/addon/static',
                self.project + '/src/customer/site/addon/static/addon-icon.png',
                ...
                self.project + '/src/customer/site/addon/tests/test_controlpanel.py',
